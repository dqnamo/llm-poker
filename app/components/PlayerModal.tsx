...
export default function PlayerModal({
  ...
  const actionsByRound = gameRounds
    .map(
      (
        round: InstaQLEntity<AppSchema, "gameRounds"> & {
          communityCards?: { cards?: string[] };
        }
      ) => {
        const roundActions = playerActions.filter(
          (
            action: InstaQLEntity<
              AppSchema,
              "actions",
              { bettingRound: object; gameRound: object }
            >
          ) => action.gameRound?.id === round.id
        );
        return {
          round,
  ...
  return (
    <>
      ...
      {isOpen && (
        <FloatingOverlay
          className="bg-black/80 z-50 flex items-center justify-center p-10"
          lockScroll
        >
          <FloatingFocusManager context={context}>
            <div
              ...
              {...getFloatingProps()}
              className="text-neutral-200   border-neutral-900 relative max-w-4xl w-full max-h-[85vh] overflow-hidden flex flex-col"
            >
              {/* <CornerBorders /> */}
              ...
              <div className="flex items-center justify-between p-4 border-neutral-900 flex-shrink-0 bg-neutral-950">
                <div className="flex items-center gap-4">
                  ...
                  {button && <div className="h-2 w-2 bg-white"></div>}
                </div>
                <button
              ...
              <div className="overflow-y-auto flex-1 bg-neutral-950">
                ...
                <div className=" border-neutral-900">
                  <div className="flex flex-col p-6 border-neutral-900">
                    <h1 className="text-sm font-semibold uppercase tracking-wider text-neutral-100">
                      Current Status
                    </h1>
                  ...
                  <div className="flex flex-row p-6 gap-8">
                    ...
                    <div className="flex flex-col items-center gap-3 min-w-0 flex-1">
                      ...
                      <div className="flex flex-col items-center gap-1">
                        <div
                          className={`flex items-center gap-2 px-3 py-2 border relative ${
                            totalWinnings >= 0
                        ...
                        >
                          <div
                            className={`border-r-2 border-t-2 h-3 w-3 absolute -top-1 -right-1 ${
                              totalWinnings >= 0
                                ? "border-lime-500/50"
                                : "border-red-500/50"
                            }`}
                          />
                          <div
                            className={`border-l-2 border-b-2 h-3 w-3 absolute -bottom-1 -left-1 ${
                              totalWinnings >= 0
                                ? "border-lime-500/50"
                                : "border-red-500/50"
                            }`}
                          />
                          <div
                            className={`border-l-2 border-t-2 h-3 w-3 absolute -top-1 -left-1 ${
                              totalWinnings >= 0
                                ? "border-lime-500/50"
                                : "border-red-500/50"
                            }`}
                          />
                          <div
                            className={`border-r-2 border-b-2 h-3 w-3 absolute -bottom-1 -right-1 ${
                              totalWinnings >= 0
                                ? "border-lime-500/50"
                                : "border-red-500/50"
                            }`}
                          ...
                          {totalWinnings >= 0 ? (
                            <>
                              ...
                              <div className="text-lg  text-lime-300 font-semibold">
                ...
                {player.notes && (
                  <div className="border-b border-neutral-900">
                    <div className="flex flex-col p-6 border-neutral-900">
                      ...
                      <p className="text-xs text-neutral-500 mt-1">
                        Accumulated insights from previous rounds
                      </p>
                    </div>
                        ...
                        <div key={roundGroup.round.id} className="p-4">
                          <div className="flex items-center gap-2 mb-4">
                            ...
                            {roundGroup.round.communityCards?.cards &&
                              roundGroup.round.communityCards.cards.length >
                                0 && (
                            ...
                            {roundGroup.actions.map(
                              (
                                ...
                                <div key={action.id} className="space-y-2">
                                  ...
                                  {action.reasoning && (
                                    <div>
                                      <div className="text-xs text-neutral-500 mb-1 font-medium uppercase">
                                        Reasoning:
                                      </div>

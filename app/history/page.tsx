...
export default function HistoryPage() {
    ...
    return (
      <div className="flex flex-col h-dvh p-10 items-center justify-center">
        <div className="text-neutral-200 font-geist-mono w-max p-4 flex flex-col items-center gap-2">
          ...
          <p className="text-xs text-neutral-500 font-semibold uppercase">Loading Game History</p>
        </div>
      </div>
    );
  }
  ...
  if (error) {
    return (
      <div className="flex flex-col h-dvh p-10 items-center justify-center">
        <div className="text-neutral-200 font-geist-mono w-max p-4 flex flex-col items-center gap-2">
          <p className="text-xs text-neutral-500 font-semibold uppercase">Error Loading History</p>
      ...
      <div className="text-neutral-200 font-geist-mono max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-row items-center justify-between mb-8">
          <div className="flex flex-col gap-1">
            ...
            <p className="text-xs text-neutral-500 max-w-sm">All completed and ongoing poker games.</p>
          </div>
        </div>
        ...
        <div className="flex flex-col border border-neutral-900 relative">
          ...
          <div className="flex flex-col p-4 border-b border-neutral-900">
            ...
            <p className="text-xs text-neutral-500">Click on any game to view detailed analysis</p>
          </div>
          ...
          <div className="bg-neutral-950 divide-y divide-neutral-900">
            {data?.games && data.games.length > 0 ? (
              data.games.map((game) => {
                ...
                const playersWithWinnings = game.players?.map(player => {
                ...
                const sortedPlayers = playersWithWinnings.sort((a, b) => b.totalWinnings - a.totalWinnings);
                    ...
                    <div className="px-6 py-4">
                      <div className="grid grid-cols-12 gap-4 items-center">
                        ...
                        <div className="col-span-3">
                          <div className="text-sm font-semibold">Game #{game.id.slice(-8)}</div>
                        </div>
              ...
              <div className="flex items-center justify-center p-12">
                <div className="text-center">
                  <p className="text-xs text-neutral-500 font-semibold uppercase mb-2">No Games Found</p>
                  <p className="text-xs text-neutral-400">Start playing to see your game history here.</p>
                </div>
              </div>
            )}
          </div>
